...
SELECTORS: Dict[str, SelectorFields] = {
    ...
    "JLL": {
        "reference": "#propertySummary > div > div.col-span-12.lg\\:col-span-10 > div > div.flex.items-center.justify-between.gap-4.max-sm\\:flex-wrap.max-sm\\:justify-center > div.flex.flex-wrap.items-center.justify-center.gap-x-4.gap-y-2.max-sm\\:order-2.sm\\:justify-start > div > span",
        "asset_type": None,
        "contract": None,
        "disponibility": "#propertySummary > div > div.col-span-12.lg\\:col-span-10 > div > div.mt-9.flex.items-start.sm\\:mt-9 > div.flex-1.\\[\\&\\:not\\(\\:last-child\\)\\]\\:mr-11 > ul > li:nth-child(2) > span.text-lg.text-neutral-700",
        "area": "#propertySummary > div > div.col-span-12.lg\\:col-span-10 > div > div.mt-9.flex.items-start.sm\\:mt-9 > div.flex-1.\\[\\&\\:not\\(\\:last-child\\)\\]\\:mr-11 > ul > li:nth-child(1) > span.text-lg.text-neutral-700 > span > span:nth-child(1)",
        "division": "#propertySummary > div > div.col-span-12.lg\\:col-span-10 > div > div.mt-9.flex.items-start.sm\\:mt-9 > div.flex-1.\\[\\&\\:not\\(\\:last-child\\)\\]\\:mr-11 > ul > li:nth-child(1) > span.text-lg.text-neutral-700 > span > span:nth-child(1) > span",
        "adress": "head > title",
        "contact": "#propertySummary > div > div.col-span-12.lg\\:col-span-10 > div > div.mt-9.flex.items-start.sm\\:mt-9 > div.inline-flex.items-center.justify-center.whitespace-nowrap.rounded.text-sm.font-semibold.ring-offset-white.transition-colors.focus-visible\\:outline-none.focus-visible\\:ring-2.focus-visible\\:ring-neutral-950.focus-visible\\:ring-offset-2.disabled\\:pointer-events-none.disabled\\:opacity-50.\\33 xl\\:text-base.text-neutral-900.underline-offset-4.hover\\:underline.h-9.px-4.py-1.\\!justify-start.\\!no-underline.mb-1.h-full.w-full.\\!rounded-md.border.bg-white.px-4.py-3.hover\\:bg-white.hover\\:shadow-md.hidden.max-w-44.cursor-pointer.lg\\:block > div.overflow-hidden.text-left > p.overflow-hidden.text-ellipsis.text-base.font-bold",
    ...
    "ARTHURLOYD": {
        ...
        "asset_type": None,
        "contract": None,
        "disponibility": "#advisor-brick-wrapper > div > div:nth-child(1) > div:nth-child(3) > div > ul > li:nth-child(2) > div.content > span",
